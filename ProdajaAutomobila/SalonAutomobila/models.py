...
class Segment(models.Model):
    ...
    def ApsolutniURL(self): return reverse('SalonAutomobila:ListaAutomobilaPoSegmentu', args=[self.slug])



class Automobil(models.Model):
    segment = models.ForeignKey(Segment, related_name='automobili',
